...
var paths = {
  ...
  javascripts: ['./src/javascripts/*.coffee', './src/javascripts/**/*.coffee'],
  html: [
    './src/html/podigee-podcast-player.html',
    './src/html/embed-example.html',
    './index.html',
  ],
  images: ['./src/images/**'],
...
gulp.task('html', ['javascripts', 'stylesheets'], function() {
  return gulp
    ...
    .pipe(
      inject(
        gulp.src(['./build/javascripts/podigee-podcast-player-embed.js'], {
          read: true,
        }),
        {
          starttag: '<!-- inject:head:{{ext}} -->',
...
gulp.task('watch', function() {
  ...
  gulp.watch(paths.javascripts, ['javascripts-dev', 'html-dev']);
